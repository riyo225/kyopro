...
int main() {
    ...
    SegmentTree<ll> segm(n, [](ll a, ll b){ return min(a, b); }, INF_LL);
    SegmentTree<ll> segM(n, [](ll a, ll b){ return max(a, b); }, -INF_LL);
    ...
    for (int i = 0; i < n-k+1; i++) {
        ll l = i;
        ll r = i+k;
        ans = max(ans, abs(segM.query(l, r) - segm.query(l, r)));
    }
